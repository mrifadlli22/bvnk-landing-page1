      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.mainSection}>
          <div className={styles.column}>
            ...
            <p className={styles.addressInfo}>PT Tennet Depository Indonesia</p>
            <p className={styles.addressInfo}>Millenium Centennial Center Lantai 2</p>
